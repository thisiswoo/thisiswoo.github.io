...
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
| `boolean` | `allMatch(Predicate<T> predicate)`<br>`allMatch(IntPredicate<T> predicate)`<br>`allMatch(LongPredicate<T> predicate)`<br>`allMatch(DoublePredicate<T> predicate)`     | 모든 요소가 만족하는지 여부    |
